                    ...
                    cars.forEach( function(car, index){
                        var row =
                            '<tr>' +
                                ...
                                '<td>' + car.price + '</td>' +
                                '<td>' +
                                    '<button id="userBookingButton" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#userBookingModal" data-id="'+ car.id +'" data-manufacturer="' + car.manufacturer + '" data-vehicle="'+  car.vehicle_name +'" data-price="'+car.price+'">'+
